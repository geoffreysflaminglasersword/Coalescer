...
export default class CoalescerListView extends ItemView {
    ...
    public readonly redraw = (): void => {
        ...
        let unt = this.app.vault.getMarkdownFiles().filter(f => !!f.basename.match(/untitled/i));
        console.log(`unt`, unt);
        let [mergeto,mergefrom] = unt;

        (this.app.fileManager as any).mergeFile(mergeto,mergefrom,{file:mergeto,type:'file',match:null},false)
