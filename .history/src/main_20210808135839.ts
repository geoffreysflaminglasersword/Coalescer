...
import CoalescerSettingsTab, { FilePath, MyPluginSettings, defaultMaxLength } from "./Settings";
import RecentFilesListView, { RecentFilesListViewType } from "./ListView";
...
export default class Coalescer extends Plugin {
	...
	public async loadData(): Promise<void> {
	  ...
	  if (!this.data.maxLength) {
		console.log(`Recent Files: maxLength is not set, using default (${defaultMaxLength})`);
	  }
	}
