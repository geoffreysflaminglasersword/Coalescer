<script lang="ts">
  ...
  import { App, ItemView, Menu, Notice, SuggestModal, TAbstractFile, TFile, WorkspaceLeaf } from "obsidian";
...
onMount(() => {
  suggest = new CoalesceSuggest(app,inputEl,[]);
  suggest.inputEl = inputEl;
})
