...
import { FuzzySuggestModal, ItemView, Menu, Notice, SuggestModal, TFile, WorkspaceLeaf } from 'obsidian';
...
export default class CoalescerListView extends ItemView {
    ...
    suggest:SuggestModal<string|TFile>;
    ...
    constructor(
        ...
        this.app.workspace.onLayoutReady(() => {
            ...
            this.suggest = new SuggestModal(this.app)
            this.redraw();
