...
<div>
  <div class="container">
    <div class="listToggles">
      ...
      <div class="checkbox-container {showFiles ? 'is-enabled' : ''}" on:click={() => {showFiles = !showFiles;await tick();}} />
      <div class="toggleText">Show Tags</div>
      <div class="checkbox-container {showTags ? 'is-enabled' : ''}" on:click={() => {showTags = !showTags;await tick();}} />
      <div class="toggleText">Show Links</div>
      <div class="checkbox-container {showLinks ? 'is-enabled' : ''}" on:click={() => {showLinks = !showLinks;await tick();}} />
    </div>
