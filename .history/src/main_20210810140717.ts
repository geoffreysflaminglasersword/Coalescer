...
import CoalescerSettingsTab, { CoalescerState, DEFAULT_SETTINGS, FilePath } from "./Settings";
...
export default class Coalescer extends Plugin {
	...
	async onload() {
		...
		console.log('here',this.app.metadataCache.resolvedLinks)
		console.log('here',this.app.metadataCache.unresolvedLinks)
