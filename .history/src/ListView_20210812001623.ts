...
export default class CoalescerListView extends ItemView {
    ...
    public readonly redraw = (): void => {
        ...
        console.log(`this.app.metadataCache.unresolvedLinks`, Object.entries(this.app.metadataCache.unresolvedLinks).map(([key,val]) => val).filter(([key,val]) => !!val))
        console.log(`this.app.metadataCache.resolvedLinks`, Object.entries(this.app.metadataCache.resolvedLinks).map(([key,val]) => val).filter(([key,val]) => !!val))
