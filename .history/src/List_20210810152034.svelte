<script lang="ts">
  ...
  $: if (pivot == null) {
    items = items.sort((a, b) => {
      ...
      if (i1 instanceof Tag && i2 instanceof Tag) return i1.basename.localeCompare(i2.basename);
  ...
  let shouldShow = (item: Item) =>
    (item instanceof File && showFiles) ||
...
<div>
  <div class="container">
    <div class="listToggles">
      ...
      <div class="checkbox-container {showLinks ? 'is-enabled' : ''}" on:click={() => (showLinks = !showLinks)} />
    </div>
