  ...
  $: if (pivot == null) {
    items = items.sort((a, b) => {
      ...
      if (i2 instanceof Tag && !(i1 instanceof Tag)) return 1;
        ...
        console.log(`i1.path,i1.basename,i2.path,i2.basename`, i1.path==i1.basename,i2.path==i2.basename, i1.path,i1.basename,i2.path,i2.basename)
        if(i1.basename+'.md' == i1.path  && i2.basename +'.md'!= i2.path) return 1;
        if(i1.basename+'.md' != i1.path  && i2.basename +'.md'== i2.path) return -1;
