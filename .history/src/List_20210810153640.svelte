...
<div>
  <div class="container">
    <div class="listToggles">
      ...
      <div class="checkbox-container {showFiles ? 'is-enabled' : ''}" on:click={async   a() => {showFiles = !showFiles;await tick();}} />
      <div class="toggleText">Show Tags</div>
      <div class="checkbox-container {showTags ? 'is-enabled' : ''}" on:click={async   a() => {showTags = !showTags;await tick();}} />
      <div class="toggleText">Show Links</div>
      <div class="checkbox-container {showLinks ? 'is-enabled' : ''}" on:click={async   a() => {showLinks = !showLinks;await tick();}} />
    </div>
